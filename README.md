...
### Awesome Collections
- 📚 [CoolEngines](https://github.com/JohnClarking/CoolEngines) - Open source graphic & game engines.
...
### Popular
- 🎉 [Godot](https://github.com/godotengine/godot#readme) - 🔥 Feature-packed, open source engine. Excellent! [[Awesome Godot](https://github.com/godotengine/awesome-godot#readme) | [Website](https://godotengine.org)]
...
- 🎉 [O3DE](https://github.com/o3de/o3de/) - (successor to Lumberyard) Multi-platform AAA engine. Cinema-quality 3D.
...
- 🎉 [Defold](https://github.com/defold/defold) - (by King) Open sourced game engine. [[Website](https://defold.com)]
...
- 💰 [Phaser Editor 2D](https://phasereditor2d.com) - Commercial, web based editor for Phaser. [[GitHub](https://github.com/PhaserEditor2D/PhaserEditor2D-v3)]
- 💸 [PlayCanvas](https://playcanvas.com) - Popular (Flappy Bird), game engine built on WebGL. [[Awesome PlayCanvas](https://github.com/playcanvas/awesome-playcanvas#readme) | [GitHub](https://github.com/playcanvas/engine)]
...
### Specialty
- 💰 [3dSen](https://geod.itch.io/3dnes) - NES emulator that lets you play NES games in 3D. [[Website](http://www.geodstudio.net)]
- 💸 [DopeFish](https://subpixel-studios.itch.io/dopefish) - Full GML Doom/Heretic map loading system for GameMaker Studio.
- 🎉 [GB Studio](https://github.com/chrismaltby/gb-studio) - Retro adventure game creator for Game Boy available for Mac, Linux and Windows.
...
- BASIC: App Framework
    ...
    - 🎉 [QB64](https://github.com/QB64Team/qb64) - Modern BASIC + OpenGL language, retains QB4.5 / QBasic compatibility.
...
- C: App Framework
    - 🎉 [glfw](https://github.com/glfw/glfw) - Cross-platform, simple API for windowing, graphics contexts, input and events.
...
- C: Audio
    - ⭐ [Miniaudio](https://github.com/mackron/miniaudio) - Single file audio playback and capture library written in C.
...
- C: File Formats
    - 🎉 [Assimp](https://github.com/assimp/assimp) - The Open Asset Importer Library. Loads 40+ 3D file formats.
...
- C: Gui
    ...
    - 🎉 [lvgl](https://github.com/lvgl/lvgl) - 🔥 Embedded GUI library with many widgets and advanced visual effects.
    - 🎉 [NAppGUI](https://github.com/frang75/nappgui_src) - Professional, well documented SDK to build desktop applications using C.
    - 🎉 [Native File Dialog](https://github.com/mlabbe/nativefiledialog) - Portably invoke native file open/save dialogs.
    - 🎉 [Nuklear](https://github.com/Immediate-Mode-UI/Nuklear) - Single-header ANSI C immediate mode cross-platform GUI library.
- C: Input
...
- C: Physics
    - 🎉 [Chipmunk](https://github.com/slembcke/Chipmunk2D) - Fast and lightweight 2D game physics library. [[Docs](https://chipmunk-physics.net/documentation.php)]
- C: Scripting
...
- C++: App Framework
    - 🎉 [Cinder](https://github.com/cinder/Cinder) - App and graphics library for macOS, Windows, Linux, iOS. [[Website](https://libcinder.org)]
...
- C++: Audio
    ...
    - 🎉 [PortAudio](https://github.com/PortAudio/portaudio) - Free, cross-platform, open source, audio I/O library.
- C++: Cross-Platform
...
- C++: Game Engine w/Editor
    ...
    - 🔒 [Enigma](https://github.com/enigma-dev/enigma-dev) - Open source Game Maker compatible 2D engine.
    ...
    - 🎉 [ezEngine](https://github.com/ezEngine/ezEngine) - Open source game engine in active development. [[Editor Info](http://ezengine.net/pages/getting-started/editor-overview.html)]
    ...
    - 🎉 [Overload](https://github.com/adriengivry/Overload) - Highly documented 3D game engine, inspired by industry standards.
    ...
    - 🎉 [Titan Engine](https://github.com/Esenthel/EsenthelEngine) - (aka Esenthel Engine) Cross-platform engine started in the year 2000.
...
- C++: Graphics - 2D
    ...
    - 🎉 [C++ Bitmap Library](https://github.com/ArashPartow/bitmap) - Incredible bitmap loading and manipulation library.
    ...
    - 🎉 [Skia](https://github.com/google/skia) - (by Google) Complete 2D graphics library used in Chrome. [[Website](https://skia.org)]
...
- C++: Graphics - 3D
    ...
    - 🎉 [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) - Modern, lightweight cross-platform graphics API abstraction library.
    - 🎉 [Ember](https://github.com/strah19/Ember) - Open source graphics framework for C++ using SDL2 and OpenGL.
    - 🎉 [Filament](https://github.com/google/filament) - (by Google) Mobile-first, real-time physically-based renderer.
...
- C++: Gui
    ...
    - 🔒 [Qt](https://github.com/qt) - Industry standard gui library. [[Awesome Qt Guide](https://github.com/mikeroyal/Qt-Guide) | [Website](https://www.qt.io)]
...
- C++: Input
    - 🎉 [Gainput](https://github.com/jkuhlmann/gainput) - Awesome, easy to use input library.
...
- C++: Layout
    - 🎉 [Yoga](https://github.com/facebook/yoga) - (by Facebook) Cross-platform [flexbox](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Flexible_Box_Layout/Basic_Concepts_of_Flexbox) layout engine. [[Website](https://yogalayout.com/)]
- C++: Libraries
...
- C++: Math
    - 🎉 [OpenGL Mathematics](https://github.com/g-truc/glm) - Header only C++ mathematics library for graphics software.
- C++: Network
...
- C++: Physics
    ...
    - 🎉 [Bullet Physics](https://github.com/bulletphysics/bullet3) - Very popular 3D physics libary.
    ...
    - 🎉 [Liquid Fun](https://github.com/google/liquidfun) - Extension of Box2D, adds particle based fluid and soft bodies. [[Demos](http://google.github.io/liquidfun/)]
...
- C++: Reflection
    - 🎉 [Boost.PFR](https://github.com/boostorg/pfr) - Very basic reflection C++14 library. Part of the Boost Libraries.
...
- C++: Scripting
    ...
    - 🔒 [ArkScript](https://github.com/ArkScript-lang/Ark) - Small, fast, functional and scripting language for C++ projects.
    ...
    - 🎉 [v8](https://github.com/v8/v8) - (by Google) High-performance JavaScript and WebAssembly engine.
- C++: Serialization
...
- C++: Utility
    ...
    - 🎉 [Tiny-Process-Library](https://gitlab.com/eidheim/tiny-process-library) - Making it simple to create and stop new processes in C++.
...
- C++: Visual Programming / Nodes
    ...
    - 🎉 [QuickQanava](https://github.com/cneben/QuickQanava) - Display graphs and relational content in a QtQuick application in C++14.
...
- C#: Cross-Platform
    - 🌎 [Blazor](https://dotnet.microsoft.com/en-us/apps/aspnet/web-apps/blazor) - (by Microsoft) C# to JavaScript (as WebAssembly) technology. [[GitHub](https://github.com/dotnet/aspnetcore/blob/main/src/Components/README.md)]
...
- C#: Game Engine w/Editor
    - 🎉 [Duality](https://github.com/AdamsLair/duality) - Modular 2D engine w/visual editor. Built on C# and OpenTK.
    - 🎉 [Flat Red Ball](https://github.com/vchelaru/FlatRedBall) - 2D engine built on MonoGame & game design tools. [[Gui Editor](http://vchelaru.github.io/Gum/) | [Website](https://flatredball.com/)]
    - 🎉 [Stride](https://github.com/stride3d/stride) - (formerly Xenko) C# game engine for realistic rendering and VR. [[Website](https://www.stride3d.net/)]
    - 💸 [Unity](https://store.unity.com/) - Biggest name in game engines, industry standard.
- C#: Game Framework
    - 🎉 [FNA](https://github.com/FNA-XNA/FNA) - Reimplementation of the Microsoft XNA Game Studio 4.0 libraries. [[Website](https://fna-xna.github.io/)]
    - 🎉 [Monofoxe](https://github.com/Martenfur/Monofoxe) - Game engine designed to simplify working with, and built on MonoGame.
    - 🎉 [MonoGame](https://github.com/MonoGame/MonoGame) - 🔥 Framework for creating cross-platform games in C#. [[Website](https://www.monogame.net/)]
...
- C#: Graphics - 3D
    - 🎉 [OpenTK](https://github.com/opentk/opentk) - C# bindings for OpenGL. [[LearnOpenGL Examples, ported to OpenTK](https://github.com/opentk/LearnOpenTK)]
    - 🎉 [Veldrid](https://github.com/mellinoe/veldrid) - Cross-platform, graphics API-agnostic rendering and compute library for .NET.
- C#: Gui
    - 🎉 [Avalonia](https://github.com/AvaloniaUI/Avalonia) - Cross-platform UI framework for .NET. [[Website](https://avaloniaui.net/)]
...
- Dart: App Framework
    - 🎉 [Flutter](https://flutter.dev) - (by Google) Open source app framework. [[Awesome Flutter](https://github.com/Solido/awesome-flutter) | [GitHub](https://github.com/flutter)]
- Dart: File Formats
    - 🎉 [image](https://github.com/brendan-duncan/image) - Library for decoding / encoding image formats, and image processing.
- Dart: Game Framework
    - 🎉 [Flame](https://github.com/flame-engine/flame) - Minimalist Flutter based 2D game engine. [[Awesome Flame](https://github.com/flame-engine/awesome-flame#readme) | [Examples](https://examples.flame-engine.org/#/) | [Tutorials](https://tutorials.flame-engine.org/#/) | [Website](https://flame-engine.org/)]
...
- Go: Game Engine w/Editor
    - 🎉 [G3N](https://github.com/g3n/engine) - OpenGL 3D Game Engine written in Go.
- Go: Game Framework
    - 🎉 [Ebitengine](https://github.com/hajimehoshi/ebiten) - A dead simple 2D game library.
    - 🎉 [Engo](https://github.com/EngoEngine/engo) - Open source 2D game framework written in Go.
...
- Haxe: Game Framework
    ...
    - 🎉 [Citrus](https://github.com/DaVikingCode/Citrus-Engine) - 2D/3D ActionScript 3 based engine. [[Website](http://citrusengine.com/)]
    ...
    - 🎉 [HaxeFlixel](https://github.com/HaxeFlixel/flixel) - Cross-platform 2D game engine powered by Haxe and OpenFL. [[Website](https://haxeflixel.com/)]
...
- Haxe: Graphics
    - 🎉 [Heaps](https://github.com/HeapsIO/heaps) - 🔥 Cross-platform 2D and 3D engine (by creators of Haxe). [[Website](https://heaps.io)]
...
- Haxe: Gui
    - 🎉 [HaxeUI](https://github.com/haxeui/haxeui-core) - Cross-platform set of styleable application centric, rich UI components.
...
- Haxe: Physics
    ...
    - 🎉 [Nape](https://github.com/HaxeFlixel/nape-haxe4) - Fast and friendly 2D rigid body physics engine. [[Demos](https://joecreates.github.io/napephys/)]
...
- Lua: Game Framework
    ...
    - 🎉 [LÖVE](https://github.com/love2d/love) - 2D framework for writing game code with Lua. [[Awesome Löve](https://github.com/love2d-community/awesome-love2d) | [Website](https://love2d.org)]
...
- Java: Game Framework
    - 🎉 [jMonkeyEngine](https://github.com/jMonkeyEngine/jmonkeyengine) - Modern 3D game development suite for Java.
    - 🎉 [libGDX](https://github.com/libgdx/libgdx) - Game framework built on, and adds to LWJGL. [[Awesome libGDX](https://github.com/rafaskb/awesome-libgdx#readme) | [Website](https://libgdx.com/)]
...
- JavaScript: Audio
    ...
    - 🎉 [PixiJS Sound](https://github.com/pixijs/sound) - Audio library with filters. Built on, and requires PixiJS. [[Examples](https://pixijs.io/sound/examples/)]
...
- JavaScript: Cross-Platform
    ...
    - 🎉 [React Native](https://github.com/facebook/react-native) - Framework for building native applications using React. [[Website](https://reactnative.dev/)]
...
- JavaScript: Docking
    - 🎉 [Dock Spawn TS](https://github.com/node-projects/dock-spawn-ts) - Maintained, TypeScript version of [Dock Spawn](https://github.com/coderespawn/dock-spawn), a html docking framework.
    - 🎉 [FlexLayout](https://github.com/caplin/FlexLayout) - Multi-tab layout manager.
    - 🎉 [Golden Layout](https://github.com/golden-layout/golden-layout) - Multi window layout manager for webapps.
    ...
    - 🎉 [RC-Dock](https://github.com/ticlo/rc-dock) - Dock Layout for React Component.
...
- JavaScript: Game Engine w/Editor
    ...
    - 🎉 [ct.js](https://github.com/ct-js/ct-js) - Desktop 2D game engine, built on PixiJS.
    ...
    - 🎉 [Superpowers](https://github.com/superpowers) - Free and open source 2D and 3D game making for indies. [[Website](http://superpowers-html5.com/index.en.html)]
    - 🎉 [Taro](https://github.com/moddio/taro) - (aka Moddio) Multiplayer game engine with Box2D physics. [[Website](https://www.modd.io)]
- JavaScript: Game Framework
    - 🎉 [Crafty](https://github.com/craftyjs/Crafty) - Game library that can help you create 2D games in a structured way.
    - 🎉 [Kaboom](https://github.com/replit/kaboom) - Simple 2D engine.
    ...
    - 🎉 [Oasis](https://github.com/ant-galaxy/oasis-engine) - (by AntGroup) WebGL engine, 2D, 3D, animation, physics.
    - 🎉 [Phaser](https://github.com/photonstorm/phaser) - Fast 2D game framework. [[Website](https://phaser.io)]
    - 🎉 [Turbulenz](https://github.com/turbulenz/turbulenz_engine) - Modular 2D/3D game framework for browsers, desktops and mobile devices.
...
- JavaScript: Graphics - 2D
    - 🎉 [CanvasKit](https://skia.org/docs/user/modules/canvaskit/) - WebAssembly build of Google's 2D graphics library, Skia. [[GitHub](https://github.com/google/skia/tree/main/modules/canvaskit)]
    - 🎉 [EaselJS](https://github.com/CreateJS/EaselJS) - Makes working with the HTML5 Canvas element easy, part of [CreateJS](https://createjs.com/).
    - 🎉 [Fabric.js](https://github.com/fabricjs/fabric.js) - Powerful and simple JavaScript HTML5 canvas library.
    - 🎉 [Konva](https://github.com/konvajs/konva) - Canvas framework enabling interactivity for desktop and mobile applications.
    ...
    - 🎉 [PixiJS](https://github.com/pixijs/pixijs) - 🔥 Fast, lightweight 2D library. [[Awesome PixiJS](https://github.com/cursedcoder/awesome-pixijs) | [Editor](https://github.com/Megabyteceer/thing-editor) | [Website](https://pixijs.com/)]
    - 🎉 [Pts](https://github.com/williamngan/pts) - Library for visualization and creative-coding. [[Examples](https://ptsjs.org)]
    - 🎉 [Scrawl-canvas](https://github.com/KaliedaRik/Scrawl-canvas) - Library for working with the HTML5 Canvas element.
    - 🎉 [Stage.js](https://github.com/shakiba/stage.js) - 2D HTML5 rendering engine for game development. [[Examples](https://piqnt.com/stage.js/)]
    - 🎉 [Two.js](https://github.com/jonobr1/two.js) - Renderer agnostic 2D drawing api for the web.
    - 🎉 [ZIM](https://github.com/danzen/zimjs) - Canvas framework for code creativity. [[Website](https://zimjs.com/)]
- JavaScript: Graphics - 3D
    - 🎉 [Babylon.js](https://github.com/BabylonJS/Babylon.js) - 🔥 Powerful, simple web rendering engine. [[Website](https://www.babylonjs.com/)]
    ...
    - 🎉 [Filament for Web](https://google.github.io/filament/webgl/) - WebAssembly build of Google's 3D graphics library, Filament. [[GitHub](https://github.com/google/filament/tree/main/web/filament-js)]
    - 🎉 [Hilo3d](https://github.com/hiloteam/Hilo3d) - (by Alibaba) WebGL 3D rendering engine.
    ...
    - ⭐ [OGL](https://github.com/oframe/ogl) - 🔥 Fast and powerful minimal WebGL library. [[Examples](https://oframe.github.io/ogl/examples)]
    ...
    - 🎉 [Three.js](https://github.com/mrdoob/three.js/) - 🔥 General-purpose 3D library. [[Awesome Three.js](https://github.com/0xAxiome/awesome-threejs) | [Docs](https://threejs.org) | [Editor](https://threejs.org/editor/) | [Examples](https://threejs.org/examples/)]
...
- JavaScript: Gui
    ...
    - 🎉 [Dojo](https://github.com/dojo/widgets) - UI widgets for modern web applications.
    ...
    - 🎉 [PCUI](https://github.com/playcanvas/pcui) - (by PlayCanvas) UI component library for the web.
    - 🎉 [Tweakpane](https://github.com/cocopon/tweakpane) - Compact GUI for fine-tuning values.
    - 🎉 [uil](https://github.com/lo-th/uil) - Simple JavaScript UI.
    - 🎉 [w2ui](https://github.com/vitmalina/w2ui) - UI widgets for modern apps.
...
- JavaScript: Physics
    ...
    - 🎉 [Matter.js](https://github.com/liabru/matter-js) - Full featured 2D physics engine for the web. [[Demos](https://brm.io/matter-js/)]
    ...
    - 🎉 [Planck.js](https://github.com/shakiba/planck.js) - JavaScript rewrite of the Box2D physics engine. [[Demos](https://piqnt.com/planck.js/)]
...
- JavaScript: Utility
    ...
    - 🎉 [jQuery](https://github.com/jquery/jquery) - Fast, small, and feature-rich JavaScript library. [[Website](https://jquery.com)]
...
- JavaScript: Timeline
    ...
    - 🎉 [Neo](https://github.com/lo-th/neo) - Lightweight timeline for JavaScript. [[Demo](http://lo-th.github.io/neo/)]
- JavaScript: Video
...
- JavaScript: Visual Programming / Nodes
    - 🎉 [Butterfly](https://github.com/alibaba/butterfly) - (by Alibaba) Diagramming library concentrated on flow and field layout.
...
- Python: Gui
    - 🎉 [Kivy](https://github.com/kivy/kivy) - Cross-platform gui framework written in Python. [[Website](https://kivy.org/)]
...
- Ruby: Framework
    - 🎉 [Ruby on Rails](https://github.com/rails/rails) - Web application framework. [[Website](https://rubyonrails.org)]
- Ruby: Game Framework
    - 🎉 [Ruby 2D](https://github.com/ruby2d/ruby2d) - Make cross-platform 2D applications in Ruby.
- Ruby: Graphics - 3D
...
- Ruby: Gui
    ...
    - 🎉 [Shoes](https://github.com/shoes/shoes4) - Cross-platform GUI library for Ruby. [[Website](http://shoesrb.com/)]
...
- Rust: Gui
    ...
    - 🔒 [Slint](https://github.com/slint-ui/slint) - (formerly SixtyFPS) Gui toolkit for embedded / desktop. [[Website](https://slint-ui.com/)]
- Rust: Physics
    - 🎉 [Rapier](https://github.com/dimforge/rapier) - 2D and 3D physics engines focused on performance. [[Docs](https://rapier.rs)]
...
- 🎉 [Etheral Legends](https://github.com/Soverance/EtherealLegends) - Indie Action RPG built with Unreal Engine 4. [[Steam](https://store.steampowered.com/app/428980/Ethereal_Legends/)]
...
- 📚 [Nomad Game Engine](https://savas.ca/nomad) - Articles building a basic ECS from the ground up in C++. [[Source](https://github.com/taurheim/NomadECS)]
...
### Shaders
- 📚 [3D Game Shaders For Beginners](https://lettier.github.io/3d-game-shaders-for-beginners/index.html) - 🔥 Shaders to improve your games. [[GitHub](https://github.com/lettier/3d-game-shaders-for-beginners)]
- 📚 [Book of Shaders](https://thebookofshaders.com) - 🔥 Step-by-step guide through [Fragment Shaders](https://www.khronos.org/opengl/wiki/Fragment_Shader). [[GitHub](https://github.com/patriciogonzalezvivo/thebookofshaders)]
...
- 🌎 [SHADERed](https://github.com/dfranx/SHADERed) - Shader IDE, written in C++, open source (MIT). [[Online Editor](https://shadered.org/app)]
...
- Bloom
    ...
    - 🌎 [Three.js: Bloom Example](https://threejs.org/examples/?q=bloom#webgl_postprocessing_unreal_bloom) - WebGL bloom postprocessing using Three.js. [[Source](https://github.com/mrdoob/three.js/blob/master/examples/webgl_postprocessing_unreal_bloom.html)]
...
- Pixelation
    ...
    - 🌎 [Three.js: Pixelation Example](https://threejs.org/examples/?q=pixel#webgl_postprocessing_pixel) - WebGL pixelation postprocessing using Three.js. [[Source](https://github.com/mrdoob/three.js/blob/master/examples/webgl_postprocessing_pixel.html)]
- Postprocessing
    - 📚 [Image Editor Effects](https://alain.xyz/blog/image-editor-effects) - WebGL image filters / effects shaders. [[GitHub](https://github.com/alaingalvan/image-editor-effects)]
- Upscaling
...
- 🆓 [Tiled](https://www.mapeditor.org) - General-purpose tile map editor for all tile-based games. [[GitHub](https://github.com/mapeditor/tiled)]

### Animation Software
- 💸 [Cascadeur](https://cascadeur.com) - 3D animation software for physics-based character animation.
- 🆓 [DragonBones](https://docs.egret.com/dragonbones/en) - Open source and free 2D game skeletal animation solution. [[GitHub](https://github.com/DragonBones/)]
...
### Audio Tools
- Music
    - 🆓 [Ardour](https://ardour.org) - Very capable. Record, edit, and mix. [[GitHub](https://github.com/Ardour/ardour)]
    - 🆓 [Audacity](https://www.audacityteam.org) - Cross-platform, multi-track audio editor and recorder. [[GitHub](https://github.com/audacity/audacity)]
    ...
    - 🆓 [FamiStudio](https://famistudio.org) - Music editor targeted at chiptune artists and NES homebrewers. [[GitHub](https://github.com/BleuBleu/FamiStudio)]
    - 💸 [fmod](https://www.fmod.com) - (used for Hades, Celeste, Untitled Goose Game) Popular audio software for games.
    - 🆓 [LMMS](https://lmms.io) - 🔥 Free, cross-platform music production software. [[GitHub](https://github.com/lmms/lmms)]
    - 🆓 [PixiTracker](https://warmplace.ru/soft/pixitracker/) - Quickly create musical sketches, chiptunes and sound experiments.
    - 🆓 [Sound Box](https://sb.bitsnbites.eu) - Compose synthetic music in your browser, great for JavaScript demos. [[GitHub](https://github.com/mbitsnbites/soundbox)]
    ...
    - 🆓 [ZzFXM](https://keithclark.github.io/ZzFXM/tracker/) - Music generator for use in tiny JavaScript productions. [[GitHub](https://github.com/keithclark/ZzFXM)]
- Sound Effects
    - 🆓 [Bfxr](https://www.bfxr.net) - Program of choice for making simple sound effects for games. [[GitHub](https://github.com/increpare/bfxr)]
    ...
    - 🆓 [ZzFX](https://killedbyapixel.github.io/ZzFX/) - Tiny JavaScript Sound FX System / Zuper Zmall Zound Zynth. [[GitHub](https://github.com/KilledByAPixel/ZzFX)]
...
- Imaging
    ...
    - 🆓 [Disco Diffusion](http://discodiffusion.com/) - Notebooks, models and techniques for AI art and animations.[[GitHub](https://github.com/alembics/disco-diffusion)]
...
- Modeling
    ...
    - 📚 [GET3D](https://nv-tlabs.github.io/GET3D/) - (by NVIDIA) Generative model of 3D shapes from images. [[GitHub](https://github.com/nv-tlabs/GET3D)]
    - 📚 [Magic3D](https://deepimagination.cc/Magic3D/) - High-resolution text-to-3D content creation.
    - 📚 [NeRF](https://www.matthewtancik.com/nerf) - View synthesis of scenes as neural radiance fields. [[GitHub](https://github.com/bmild/nerf)]
- Sound
...
### Image Editors
- 🆓 [GIMP](https://www.gimp.org) - GNU Image Manipulation Program, open source cross-platform image editor. [[GitHub](https://github.com/GNOME/gimp)]
- 🆓 [Photopea](https://www.photopea.com) - Very capable online photo editor.

### Level Editors
- 🆓 [Radiant](https://icculus.org/gtkradiant/) - Cross-platform level editor for [idTech](https://en.wikipedia.org/wiki/Id_Tech) games. [[GitHub](https://github.com/TTimo/GtkRadiant)]
- 🆓 [TrenchBroom](https://trenchbroom.github.io) - Level editor for Quake-engine based games. [[GitHub](https://github.com/TrenchBroom/TrenchBroom)]

### Materials / Textures
- 🆓 [ArmorLab](https://armorlab.org) - Generate PBR materials by drag & dropping your photos. [[GitHub](https://github.com/armory3d/armorlab)]
...
- 🆓 [Material Maker](https://www.materialmaker.org) - Procedural [Physically Based Rendering](https://en.wikipedia.org/wiki/Physically_based_rendering) material maker. [[GitHub](https://github.com/RodZill4/material-maker)]
- 🆓 [Materialize](http://boundingboxsoftware.com/materialize/) - Tool for creating materials from images to be used in games. [[GitHub](https://github.com/BoundingBoxSoftware/Materialize)]
...
- 🆓 [Texgen.js](https://texgenjs.org) - JavaScript texture generator tool. [[GitHub](https://github.com/mrdoob/texgen.js)]
- 🆓 [TexTools for Blender](http://www.renderhjs.net/?doc=texToolsBlender) - Addon for Blender with UV and Texturing tools. [[GitHub](https://bitbucket.org/renderhjs/textools-blender/src/master/)]

### Modeling Tools
- 💰 [3DS Max](https://www.autodesk.com/products/3ds-max/) - One of the oldest software programs for 3D modeling and rendering.
- 🆓 [ArmorPaint](https://armorpaint.org) - Physically-based texture painting, drop in your 3D models and paint. [[GitHub](https://github.com/armory3d/armorpaint)]
- 💰 [Asset Forge](https://assetforge.io) - Allows anyone to create 3D models and 2D sprites using building blocks.
- 🆓 [Blender](https://www.blender.org) - 🔥 The standard for open source 3D modeling. [[GitHub](https://github.com/blender/blender)]
- 🆓 [Meshroom](https://alicevision.org/#meshroom) - 3D reconstruction software based on the AliceVision framework. [[GitHub](https://github.com/alicevision/meshroom)]
...
### Pixel Art
- 💸 [Aseprite](https://www.aseprite.org) - Animated sprite editor and pixel art tool. [[GitHub](https://github.com/aseprite/aseprite)]
...
- 🆓 [Piskel](https://www.piskelapp.com) - Online editor for animated sprites & pixel art. [[GitHub](https://github.com/piskelapp/piskel)]
...
### Vector Editors
- 🆓 [Inkscape](https://inkscape.org) - Cross-platform, open source vector graphics editor. [[GitHub](https://github.com/inkscape/inkscape)]
- 🆓 [Krita](https://krita.org/en/) - Professional free and open source painting program. [[GitHub](https://github.com/KDE/krita)]
